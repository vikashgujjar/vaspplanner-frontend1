...
import { FaBabyCarriage, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
import { fetchProductsByCategory } from '../services/productService';
import Link from 'next/link';

export default function WelcomeBabyBalloon() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const data = await fetchProductsByCategory('welcome-baby-balloon');
                setProducts(data.products || []);
            } catch (error) {
                console.error("Failed to fetch welcome baby balloons:", error);
            } finally {
                setLoading(false);
            }
        };
                ...
                <div className="relative">
                    ...
                    <div className="flex sm:flex-nowrap flex-wrap items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-12 min-w-12 h-12 rounded-xl bg-cyan-500 text-white shadow-md">
                        ...
                        <Link
                            ...
                            className="hidden md:flex items-center gap-2 text-sm font-semibold text-gray-700 hover:text-cyan-600 transition-colors"
                        >
                            <span>View All</span>
