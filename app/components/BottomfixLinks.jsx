        ...
        <div className="relative bg-gradient-to-b from-white to-white rounded-t-[40px] shadow-[0_-8px_30px_rgba(0,0,0,0.1)] pt-2 pb-3 border-t border-pink-200/50">
          <div className="flex items-center justify-around px-2 relative">
            ...
            <div className="relative -mt-16 flex flex-col items-center">
              <Link
                href="/cart"
                className="relative flex items-center justify-center w-[60px] h-[60px] bg-gradient-to-br from-pink-600 via-pink-500 to-pink-400 rounded-full shadow-[0_15px_40px_rgba(5,150,105,0.5)] hover:shadow-[0_18px_45px_rgba(5,150,105,0.6)] transition-all hover:scale-110 active:scale-95 border-[6px] border-white group"
              >
                {/* Glow Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-pink-400/20 to-pink-400/20 rounded-full blur-xl group-hover:blur-2xl transition-all"></div>
                ...
                {/* Pulse Ring */}
                <div className="absolute inset-0 rounded-full border-2 border-pink-400/30 animate-ping"></div>
              </Link>
            </div>
