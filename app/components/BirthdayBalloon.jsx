...
export default function BirthdayBalloon() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                ...
                console.error("Failed to fetch birthday products:", error);
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div className="relative py-8 lg:py-8 bg-amber-50">
                ...
                <div className="relative">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Link
                            ...
                            className="hidden md:flex items-center gap-2 text-sm font-semibold text-gray-700 hover:text-amber-500 transition-colors"
                        >
                            <span>View All</span>
