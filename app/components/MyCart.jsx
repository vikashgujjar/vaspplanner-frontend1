        ...
        <div className="bg-white overflow-y-auto h-full w-full md:w-[60%] lg:w-[50%] xl:w-[35%] shadow-2xl">
          ...
          <div className="flex flex-col items-center justify-center px-6 py-20">
            ...
            <Link
              ...
              onClick={() => setCart(false)}
              className="group relative overflow-hidden uppercase font-semibold text-white px-8 py-3.5 rounded-lg bg-gradient-to-r from-[#C82C6B] to-[#8c1d49] hover:from-[#8c1d49] hover:to-[#C82C6B] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
                      ...
                      <div className="card group bg-white shadow-sm hover:shadow-lg transition-all duration-300 rounded-lg overflow-hidden border border-gray-100">
                        ...
                        <div className="p-3 space-y-2">
                          ...
                          <Link
                            ...
                            className="text-white text-xs w-full py-2 text-center flex items-center justify-center rounded-md bg-[#C82C6B] hover:bg-[#8c1d49] transition-all duration-300 font-medium shadow-sm"
                          >
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center gap-3 justify-between">
                ...
                <Link href="/cart" onClick={() => setCart(false)} className="cursor-pointer w-full flex-auto">
                  <button className="group px-2 relative overflow-hidden w-full uppercase font-bold text-xs md:text-base text-white py-3.5 rounded-lg bg-gradient-to-r from-[#C82C6B] to-[#8c1d49] hover:from-[#8c1d49] hover:to-[#C82C6B] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
