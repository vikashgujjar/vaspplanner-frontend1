...
import { FaChevronLeft, FaChevronRight, FaBaby } from 'react-icons/fa6';
import { fetchProductsByCategory } from '../services/productService';
import Link from 'next/link';

export default function BabyShowerPackages() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const data = await fetchProductsByCategory('baby-shower-packages');
                setProducts(data.products || []);
            } catch (error) {
                console.error("Failed to fetch baby shower packages:", error);
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div className="relative py-8 lg:py-8 bg-blue-50">
                ...
                <div className="relative">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Link
                            ...
                            className="hidden md:flex items-center gap-2 text-sm font-semibold text-gray-700 hover:text-blue-500 transition-colors"
                        >
                            <span>View All</span>
